...
var _excluded = ["children", "projectID", "defaultLanguage", "forceUserLanguage", "i18nTags", "remoteSource", "gt"];
          ...
          traverseI18N = function traverseI18N(child) {
            if ( /*#__PURE__*/React.isValidElement(child)) {
              ...
              if (!(0, _checkPrimitives.markedForExclude)(type)) {
                if (shouldI18N(type)) {
                  var _I18NData;
                  var html = (0, _renderStrings.createChildrenString)(child);
          ...
          renderI18N = function renderI18N(child) {
            if ( /*#__PURE__*/React.isValidElement(child)) {
              ...
              if ((0, _checkPrimitives.markedForExclude)(type)) {
                ...
                var _I18NData2;
                var html = (0, _renderStrings.createChildrenString)(child);
                if ((_I18NData2 = I18NData) !== null && _I18NData2 !== void 0 && _I18NData2[html]) {
                  var _I18NData3;
                  return (0, _renderStrings.renderStrings)(child, (_I18NData3 = I18NData) === null || _I18NData3 === void 0 ? void 0 : _I18NData3[html]);
                } else {
