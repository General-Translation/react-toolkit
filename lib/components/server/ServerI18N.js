...
var _excluded = ["children", "projectID", "page", "defaultLanguage", "forceUserLanguage", "i18nTags", "remoteSource", "gt"];
var _process;
...
function _ServerI18N() {
  _ServerI18N = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
    var children, projectID, _ref$page, page, _ref$defaultLanguage, defaultLanguage, _ref$forceUserLanguag, forceUserLanguage, _ref$i18nTags, i18nTags, _ref$remoteSource, remoteSource, _ref$gt, gt, languageJSONs, userLanguage, translationRequired, I18NData, response, shouldI18N, htmlStrings, traverseI18N, traverseChildren, translations, renderI18N, renderChildren, I18NChildren;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          children = _ref.children, projectID = _ref.projectID, _ref$page = _ref.page, page = _ref$page === void 0 ? 'default' : _ref$page, _ref$defaultLanguage = _ref.defaultLanguage, defaultLanguage = _ref$defaultLanguage === void 0 ? 'en' : _ref$defaultLanguage, _ref$forceUserLanguag = _ref.forceUserLanguage, forceUserLanguage = _ref$forceUserLanguag === void 0 ? '' : _ref$forceUserLanguag, _ref$i18nTags = _ref.i18nTags, i18nTags = _ref$i18nTags === void 0 ? ['p', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'ol', 'ul'] : _ref$i18nTags, _ref$remoteSource = _ref.remoteSource, remoteSource = _ref$remoteSource === void 0 ? true : _ref$remoteSource, _ref$gt = _ref.gt, gt = _ref$gt === void 0 ? defaultDriver : _ref$gt, languageJSONs = _objectWithoutProperties(_ref, _excluded);
        ...
        case 20:
          ...
          // CHECKS
          shouldI18N = function shouldI18N(type) {
          ...
          traverseI18N = function traverseI18N(child) {
            if ( /*#__PURE__*/React.isValidElement(child)) {
              ...
              if (!(0, _checkPrimitives.markedForExclude)(type)) {
                if (shouldI18N(type)) {
                  var html = (0, _renderStrings.createChildrenString)(child, new _renderStrings.ComponentNamer());
                  if (!I18NData[html]) {
          ...
          */
            ...
            if ( /*#__PURE__*/React.isValidElement(child)) {
              ...
              if ((0, _checkPrimitives.markedForExclude)(type)) {
                ...
                if ((_I18NData = I18NData) !== null && _I18NData !== void 0 && _I18NData[html]) {
                  var _I18NData2;
                  return (0, _renderStrings.renderStrings)(child, (_I18NData2 = I18NData) === null || _I18NData2 === void 0 ? void 0 : _I18NData2[html]);
                } else {
          ...
          renderChildren = function renderChildren(child) {
            if ( /*#__PURE__*/React.isValidElement(child)) {
              ...
              if ((0, _checkPrimitives.markedForExclude)(type)) {
                return child;
              } else if ((0, _checkPrimitives.markedForI18N)(type)) {
          ...
          I18NChildren = React.Children.toArray(children).map(function (child) {
