    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 20:
          ...
          */
          renderStrings = function renderStrings(child, translationArray) {
            if (!translationArray) {
              return child;
            }
            ;
            if ( /*#__PURE__*/React.isValidElement(child)) {
              ...
              if (markedForExclude(type)) {
                ...
                return /*#__PURE__*/React.cloneElement(child, _objectSpread(_objectSpread({}, props), {}, {
                  children: translationArray.map(function (item) {
            ...
            if ( /*#__PURE__*/React.isValidElement(child)) {
              ...
              if (markedForExclude(type)) {
                ...
                if ((_I18NData2 = I18NData) !== null && _I18NData2 !== void 0 && _I18NData2[html]) {
                  var _I18NData3;
                  return renderStrings(child, (_I18NData3 = I18NData) === null || _I18NData3 === void 0 ? void 0 : _I18NData3[html]);
                } else {
