...
function renderChildren(source, target) {
  ...
  return target.map(function (targetChild, index) {
    if (typeof targetChild === 'string') {
      ...
      if (!matchingSource) {
        matchingSource = source.find(function (component) {
          var _component$props3;
          return _typeof(component) === 'object' && typeof (component === null || component === void 0 || (_component$props3 = component.props) === null || _component$props3 === void 0 ? void 0 : _component$props3.generaltranslation) !== 'number';
        });
      }
